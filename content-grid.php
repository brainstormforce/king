...
<?php else : ?>	
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
        ...
        <div class="entry-summary <?php echo $cls; ?>">
	    	...
	    	<?php if(($grid_post_format == 'video') || ($grid_post_format == 'aside') || ($grid_post_format == 'image') || ($grid_post_format == 'status') || ($grid_post_format == 'quote')) { ?>

		    	<div class="<?php echo $grid_post_format; ?>">
					<?php the_content(); ?>
				</div><!-- post-fromat -->

			<?php } else if($grid_post_format == 'link') { ?>
