...
( function( $ ) {
	...
	jQuery(document).ready(function($) {
		...
		$('.king-color-control').each(function() {
			var $control = $(this),
			...
			$('<div class="king-alpha-container"><div class="slider-alpha"></div><div class="transparency"></div></div>').appendTo($control.parents('.wp-picker-container'));
